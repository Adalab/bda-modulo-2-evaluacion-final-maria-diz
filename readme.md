...
• Manejarlos resultados de un json para su limpieza y extracción de datos.* • Saber extraer datos con Beautiful Soup y Selenium
SQL
• Dominar las queries básicas: SELECT; UPDATE; DELETE; INSERT * • Dominar las funciones groupby, where y `having``. *
• Dominar el uso de joins (incluyendo union y `union all``)*
• Dominar el uso de subconsultas. *
• Dominar el uso de las subconsultas correlacionadas • CTE’s